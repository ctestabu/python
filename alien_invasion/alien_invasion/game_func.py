...
def create_fleet(ai_settings, stats, screen, ship, aliens, bullets):
    alien = Alien(ai_settings, screen)
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship,
    ...
    # chck here if needed to include in cycle
    sb.prep_score()
    ...
    if len(aliens) == 0:
        ...
        stats.level += 1
        sb.prep_level()
        create_fleet(ai_settings, stats, screen, ship, aliens, bullets)
